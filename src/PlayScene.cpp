...
void PlayScene::GUI_Function() const
{
	...
	ImGui::Begin("GAME 3001 Lab 2 Peoples Sean", NULL, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_MenuBar);
	...
	if (ImGui::Button("Reset"))
	{
		...
		m_pSpaceShip->setRotation(0.0f); // set rotation angle to 0 degrees
		turn_rate = 5.0f;
